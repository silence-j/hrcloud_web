...
export default {
  data () {
    return {
      ...
      moveFormRules: {
        ...
        fundStop: { required: true, message: '请选择社保缴纳至', trigger: 'change' },
        fundDate: { required: true, message: '请选择公积金缴纳', trigger: 'change' },
        salaryDate: { required: true, message: '请选择工资结算至', trigger: 'change' },
  ...
  methods: {
    ...
    transferMsg (row) {
      ...
      // this.orgDatas.orgId = row.deptNo
      // this.orgDatas.filterName = row.deptName
