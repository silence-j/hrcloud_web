<template>
  <div class="container">
    <el-tabs
      ...
      <el-tab-pane v-if="getCurrentRoleGroups.indexOf('contractVoid')!==-1">
...
export default {
  ...
  methods: {
    ...
    /** 待审核**/
    _getwaitTaskList () {
      getTaskList(Object.assign(this.contractWaitParams, { groupId: 'contractVoid' })).then(data => {
        if (data.result) {
          if (data.result.records) {
