  ...
  <div class="container">
    ...
    <div class="content-box">
      <el-form label-width="120px">
        ...
        <el-row align="center">
          <el-col :span="24">
            <el-form-item label="原工资标准:">{{jobAuditDetailsData.wageLevel}}</el-form-item>
          </el-col>
        </el-row>
        <el-row align="center" v-show="jobAuditDetailsData.newWageLevel">
          <el-col :span="24">
            <el-form-item label="新工资标准:" >{{jobAuditDetailsData.newWageLevel}}</el-form-item>
          </el-col>
        </el-row>
        <el-row align="center">
          <el-col :span="8">
  ...
  methods: {
    ...
    UnagreeSave () {
      ...
      let dutyParams = {
        ...
        newWageLevel: this.jobAuditDetailsData.newWageLevel,
    ...
    agreeMsg () {
      ...
      dutyPass(dutyParams).then((data) => {
        getTaskComplete(complateParams).then((data) => {
          this.$message.success('操作成功')
          setTimeout(() => {
            this.$router.replace('/verify/job/addVerifyJob')
          }, 400)
        })
      })
    },
