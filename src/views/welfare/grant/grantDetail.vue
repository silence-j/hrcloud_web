<template>
  <div>
    ...
    <el-form :model="postForm">
      <div class="search-form_box clearfix length-box search">
        ...
        <div class="search-form_button pt-3">
          <el-button type="primary" size="small" @click="normalSearch">查询</el-button>
          <!--<el-button size="small" @click="seniorSearch">高级查询</el-button>-->
        </div>
      </div>
    </el-form>
    <div class="table-data">
      <el-table :summary-method="getSummaries" show-summary  :data="grantDetailList">
        ...
        <el-table-column prop="zhengShi" label="正式员工" width="185px"></el-table-column>
        <el-table-column prop="shiYong" label="试用" width="185px"></el-table-column>
        <el-table-column prop="tuiXiu" label="退休" width="185px"></el-table-column>
    ...
    <form  style="display:none" name="form" method="POST" ref="submitExcel" target="_blank" :action="hostBaseUrl+'/duty/welfareTemplate/exportManageTalbleEntity'">
...
export default {
  data () {
    return {
      pp: 'http://172.16.9.136:8080/welfareTemplate/exportManageTalbleEntity',
      hostBaseUrl: '',
      grantDetailList: [],
  ...
  methods: {
    ...
    _getControllerList () {
      ...
      WelfareApi.getControllerListMang(params).then(res => {
        if (res.result) {
